      ...
      <div className='container-fluid mt-5'>
        <div style={{backgroundColor:"#a02279",height:"45rem"}} className='row justify-content-around align-items-center'>
          ...
          <h1 className='text-white mb-5'>Metabnb NFTs</h1>
            ...
            <p style={{width:"20rem",height:"8.5rem",fontSize:"1.4em",marginBottom:"70px"}} className="text-white">Discover our NFT gift cards collection. Loyal customers gets amazing gift cards which are traded as NFTs. These NFTs gives our cutomer access to loads of our exclusive services.
            </p>
