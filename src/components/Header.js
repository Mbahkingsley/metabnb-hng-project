    ...
    {/* <div style={{width:"100%",backgroundColor:"white",height:"8rem"}} className="fixed-top" > */}
      <header className="container d-flex flex-wrap justify-content-between mt-4 ">
        ...
        <div style={{width:"60%"}} className="pt-2 d-flex justify-content-around align-items-center flex-wrap ">
          <a style={{fontSize:"2.5vw"}} className="text-decoration-none text-secondary" href="*">Home</a>
          <a style={{fontSize:"2.5vw"}} className="text-decoration-none text-secondary" href="*">Place to Stay</a>
          <a style={{fontSize:"2.5vw"}} className="text-decoration-none text-secondary" href="*">NFTs</a>
          <a style={{fontSize:"2.5vw"}} className="text-decoration-none text-secondary" href="*">Community</a>
        </div>
